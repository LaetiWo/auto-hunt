...
const FormGenerator: React.FC<FormGeneratorProps> = ({
  ...
  return (
    <div className="grid gap-2">
      ...
      {fieldType === "currency" && (
        <div className="relative">
          ...
          <Input
            id={name}
            type="text"
            className="!h-12 text-sm shadow-none placeholder:!text-muted-foreground pl-6"
            disabled={disabled}
            placeholder={placeholder || label}
            defaultValue={defaultValue}
            {...register(name, {
      ...
      {fieldType === "switch" && (
        <div className="flex items-center justify-between space-x-2 p-4 border rounded-md bg-gray-50/50">
